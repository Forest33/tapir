...
func (m *V2) pushToWaitingListLog(msg *entity.Message, waitingList *waitingList) {
	if !m.cfg.Tracing {
		return
	}
...
func (m *V2) popFromWaitingListLog(msg *entity.Message, waitingList *waitingList) {
	if !m.cfg.Tracing {
		return
	}
...
func (m *V2) senderLog(msg *entity.Message, waitingList *waitingList) {
	if !m.cfg.Tracing {
		return
	}
