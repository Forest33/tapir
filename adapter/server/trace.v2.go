...
func (s *V2) sendMessageLog(data []byte, size int, msg *entity.Message, description string) {
	if !s.cfg.Tracing {
		return
	}
...
func (s *V2) receiveMessageLog(data interface{}, size int, msg *entity.Message) {
	if !s.cfg.Tracing {
		return
	}
